...
class Ladmcoluv:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&LADM COL UV')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Ladmcoluv', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ladm_col_uv/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
